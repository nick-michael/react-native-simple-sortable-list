...
export default class Row extends Component {
  ...
  _panResponder = PanResponder.create({
    ...
    onPanResponderMove: (e, gestureState) => {
      ...
      if (this.props.onMove) {
        this.props.onMove(e, gestureState, this._nextLocation, this._layout);
      }
    },
  ...
  render() {
    ...
    //   { transform: [{ translateY: this._animatedLocation.y }]},
    //   styles.verticalContainer,
    // ];
  ...
  _mapGestureToMove(prevGestureState, gestureState) {
    return {dy: gestureState.moveY - prevGestureState.moveY};
  }
